...
func _ready() -> void:
	...
	tween.set_parallel()
	tween.tween_property($DialogText, "anchor_left", anchor_array[0], 0)
	tween.tween_property($DialogText, "anchor_top", anchor_array[1], 0)
	tween.tween_property($DialogText, "anchor_right", anchor_array[2], 0)
	tween.tween_property($DialogText, "anchor_bottom", anchor_array[3], 0)
